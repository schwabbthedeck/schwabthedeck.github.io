  ...
  return (
    <Layout>
      ...
      <div class="grid grid-cols-1 grid-flow-row gap-4 pt-16 m-1 place-content-stretch items-center">
        ...
        <div class="p-16 h16 flex items-center justify-center">
          <ChevronDown></ChevronDown>
        </div>
        <div class="p-16 h16 flex items-center justify-center text-xl">
        ...
        <div class="p-16 h16 flex items-center justify-center text-xl">
          <p>(This will be more fun with the sound on.)</p>
        </div>
